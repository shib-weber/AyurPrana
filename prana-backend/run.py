...
from app.routers import auth, trials, contracts, pharmacovigilance, cdisc_fhir, audit, health, chat, documents, exports
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "http://127.0.0.1:5173", "https://ayur-prana.vercel.app"],
...
app.include_router(exports.router) # <--- Added for Daily Health Logs & Doctor Solutions
